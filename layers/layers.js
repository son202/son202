...
lyr_Batis_2.set('fieldLabels', {'fid': 'inline label', 'gid,N,10,0': 'inline label', 'ID,N,24,15': 'inline label', 'FLAG_DUPLI': 'inline label', 'NGDC_DATE,': 'inline label', 'TEMPORAL_A': 'inline label', 'EQ_YEAR,N,': 'inline label', 'EQ_MONTH,N': 'header label', 'EQ_DAY,N,1': 'inline label', 'HOUR,N,10,': 'header label', 'MINUTE,N,1': 'header label', 'LATITUDE,N': 'header label', 'LONGITUDE,': 'inline label', 'DEPTH_KM,N': 'header label', 'MAGNITUDE_': 'header label', 'Descriptio': 'header label', 'INTENSITY,': 'header label', 'DEATH_DESC': 'header label', 'NUMBER_OF_': 'header label', 'DAMAGE_DES': 'header label', 'DAMAGE_MIL': 'header label', 'FLAG_TSUNA': 'header label', 'LOCATION_D': 'header label', 'SLIDES_URL': 'header label', 'MAP_SLIDE_': 'inline label', 'OBJECTID,N': 'inline label', });
