...
lyr_Batis_2.set('fieldLabels', {'fid': 'inline label', 'gid,N,10,0': 'inline label', 'ID,N,24,15': 'inline label', 'FLAG_DUPLI': 'no label', 'NGDC_DATE,': 'inline label', 'TEMPORAL_A': 'inline label', 'EQ_YEAR,N,': 'no label', 'EQ_MONTH,N': 'header label', 'EQ_DAY,N,1': 'no label', 'HOUR,N,10,': 'header label', 'MINUTE,N,1': 'header label', 'LATITUDE,N': 'header label', 'LONGITUDE,': 'inline label', 'DEPTH_KM,N': 'inline label', 'MAGNITUDE_': 'inline label', 'Descriptio': 'inline label', 'INTENSITY,': 'inline label', 'DEATH_DESC': 'inline label', 'NUMBER_OF_': 'inline label', 'DAMAGE_DES': 'inline label', 'DAMAGE_MIL': 'inline label', 'FLAG_TSUNA': 'inline label', 'LOCATION_D': 'inline label', 'SLIDES_URL': 'inline label', 'MAP_SLIDE_': 'inline label', 'OBJECTID,N': 'inline label', });
